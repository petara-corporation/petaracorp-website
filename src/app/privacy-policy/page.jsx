...
const metadata = {
    ...
    description:
        'Read the privacy policy of Petara Corporation to understand how we collect, use, and protect your personal data.',
    keywords:
        'Privacy Policy, Petara Corporation, Data Protection, User Rights, Personal Information Security',
...
const PrivacyPolicy = () => {
    return [
        ...
        <section className="container mx-auto p-6">
            ...
            <p className="mb-4">
                Petara Corporation ("we", "our", "us") is committed to protecting your privacy.
                This Privacy Policy explains how we collect, use, and safeguard your information
                when you submit a form, contact us, or interact with our promotional campaigns.
            </p>
            ...
            <p className="mb-4">
                We retain your information as long as needed to fulfill your request or as required for
            ...
            <p className="mb-2 font-medium">📩 petaracorporation@gmail.com</p>
            <p className="mb-6 font-medium">📞 8879292103</p>
            ...
            <p className="mb-2">
                If you have any questions regarding this policy or our data practices, contact us at:
            </p>
            <p className="font-medium mb-1">Petara Corporation</p>
